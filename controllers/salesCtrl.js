...
const generateHTMLContent = (orders, reportDetails, fromDate, toDate) => {
    ...
    const tableRows = orders.map(order => `
        <tr>
            ...
            <td>${order.addressSnapshot.houseNumber}, ${order.addressSnapshot.street}, ${order.addressSnapshot.city}, ${order.addressSnapshot.zipcode}, ${order.addressSnapshot.country}</td>
    ...
    if (format === 'excel') {
        ...
        orders.forEach(order => {
            worksheet.addRow({
                ...
                address: `${order.addressSnapshot.houseNumber}, ${order.addressSnapshot.street}, ${order.addressSnapshot.city}, ${order.addressSnapshot.zipcode}, ${order.addressSnapshot.country}`,
        ...
        doc.fontSize(20).text('SMILE SHOP', { align: 'center' });
        ...
        orders.forEach(order => {
            ...
            doc.fontSize(10).text(`Shipping Address: ${order.addressSnapshot.houseNumber}, ${order.addressSnapshot.street}, ${order.addressSnapshot.city}, ${order.addressSnapshot.zipcode}, ${order.addressSnapshot.country}`);
