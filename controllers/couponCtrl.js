const Coupon = require('../model/couponSchema'); // Adjust the path as necessary
...
const addCoupon = async (req, res) => {
    try {
        ...
        // Check if the coupon code already exists (case-sensitive)
        const existingCoupon = await Coupon.findOne({ code: { $regex: `^${code}$`, $options: '' } });
        if (existingCoupon) {
